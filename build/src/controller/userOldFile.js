...
exports.deleteuser = exports.updateUser = exports.OtpVerification = exports.signUp = exports.sellstock = exports.buystock = exports.getUser = void 0;
...
const buystock = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const money = Number(fund['equity'].net.toFixed(11));
        ...
        for (let i = 0; i < alluserdata.length; i++) {
            ...
            if (alluserdata[i].access_key && Number(totalprice) <= Number(money)) {
                userTradeEnter.push({
...
//# sourceMappingURL=userOldFile.js.map